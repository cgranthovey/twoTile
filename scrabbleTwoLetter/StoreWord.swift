...
//    private var _on = ScrabbleWord(word: "On", partOfSpeech: "preposition", definition: "In contact with another object", image: "http://wac.450f.edgecastcdn.net/80450F/rev967.com/files/2013/10/Cup-of-coffee-on-table-in-cafe.jpg")
    ...
    func getWord() -> [ScrabbleWord]{
        return [_aa, _ab, _ad, _ae, _ag]
        //, _ah, _ai, _al, _am, _an, _ar, _as, _at, _aw, _ax, _ay, _ba, _be, _bi, _bo, _by, _de, _do, _ed, _ef, _eh, _el, _em, _en, _er, _es, _et, _ex, _fa, _fe, _fy, _gi, _go, _gu, _ha, _he, _hi, _hm, _ho, _id, _if, _in, _is, _it, _jo, _ka, _ki, _la, _li, _lo, _ma, _me, _mi, _mm, _mo, _mu, _my, _na, _ne, _no, _nu, _od, _oe, _of, _oh, _oi, _om, _on
    }
}
